...
export default {
  ...
  methods: {
    ...
    sidepanelContactFn() {
      this.snackbar = true;
      let sideDash = '<p>If you have any questions please contact us on:<br><a href="tel:='+ this.sidepanelContactInfo.phoneNumber +'">'+ this.sidepanelContactInfo.phoneNumber +'</a> <br>or email us at <br><a href="mailto:'+ this.sidepanelContactInfo.email +'">'+ this.sidepanelContactInfo.email +'</a>.</p>'
      this.$copyText(sideDash);
